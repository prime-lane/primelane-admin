...
export const commissionColumns = [
  ...
  commissionHelper.accessor('settlement_date', {
    ...
    cell: (info) =>
      format(formatToLocalTimeZone(info.getValue()), 'dd/MM/yyyy, hh:mma'),
  }),
...
export const driverSettlementColumns: ColumnDef<DriverSettlement>[] = [
  ...
  },
  {
    ...
    header: 'Settlement Date',
    cell: (info) =>
      format(formatToLocalTimeZone(info.getValue() as string), 'dd/MM/yyyy, hh:mma'),
  },
  {
    accessorKey: 'trip_id',
    header: 'Trip ID / Type',
  ...
  {
    accessorKey: 'fare_charged',
    header: 'Fare Charged',
    cell: (info) => `₦${(info.getValue() as number).toLocaleString()}`,
  },
  {
    accessorKey: 'platform_earning',
    header: 'Platform Earning',
    cell: (info) => `₦${(info.getValue() as number).toLocaleString()}`,
  },
  {
